...
coso_tb_dudoan <- function(pl){
  ...
  vt_dudoan_2019 <- c()
  vt_dudoan_2019_6thdau <- c()
  vt_dudoan_2019_9thdau <- c()
  vt_dudoan_2020 <- c()
  i <- 1
  while(i <= sl_hoatchat){
    ...
    dudoan_2019_6thdau <- sum(fit$mean[1:6])
    dudoan_2019_9thdau <- sum(fit$mean[1:9])
    vt_dudoan_2019_6thdau <- c(vt_dudoan_2019_6thdau, dudoan_2019_6thdau)
    vt_dudoan_2019_9thdau <- c(vt_dudoan_2019_9thdau, dudoan_2019_9thdau)
  ...
  data.frame(vt_hoatchat, vt_coso_tb_2014_2018, vt_dudoan_2019, vt_dudoan_2020, vt_dudoan_2019_6thdau, vt_dudoan_2019_9thdau)
}
```
...
write.csv(dudoan, "/home/hackagon/nckh-holt-winters/csv/dudoan.csv")
```
