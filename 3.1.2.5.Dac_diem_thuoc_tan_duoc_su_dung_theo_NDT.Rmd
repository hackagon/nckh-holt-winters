...
nhomdieutri_cp_thuoc <- tonghop %>%
  group_by(nhomdieutri) %>%
  summarise(xuattrongky_thanhtien = sum(xuattrongky_thanhtien, na.rm = TRUE)) %>%
  arrange(desc(xuattrongky_thanhtien)) %>%
  mutate(xuattrongky_thanhtien_percent = xuattrongky_thanhtien*100/sum(xuattrongky_thanhtien)) %>%
  top_n(5)
```
...
nhomdieutri_cp_thuoc_nam_2014 <- nhomdieutri_cp_thuoc_nam(c(18, 23, 7, 4, 19), 2014)
nhomdieutri_cp_thuoc_nam_2015 <- nhomdieutri_cp_thuoc_nam(c(18, 23, 7, 4, 19), 2015)
nhomdieutri_cp_thuoc_nam_2016 <- nhomdieutri_cp_thuoc_nam(c(18, 23, 7, 4, 19), 2016)
nhomdieutri_cp_thuoc_nam_2017 <- nhomdieutri_cp_thuoc_nam(c(18, 23, 7, 4, 19), 2017)
nhomdieutri_cp_thuoc_nam_2018 <- nhomdieutri_cp_thuoc_nam(c(18, 23, 7, 4, 19), 2018)
```
...
nhomdieutri_sl_thuoc <- tonghop %>%
  group_by(nhomdieutri) %>%
  summarise(sl_thuoc = n_distinct(ThuongMai)) %>%
  arrange(desc(sl_thuoc)) %>%
  mutate(sl_thuoc_percent = sl_thuoc*100/sum(sl_thuoc)) %>%
  top_n(5)
```
...
nhomdieutri_sl_thuoc_nam_2014 <- nhomdieutri_sl_thuoc_nam(c(18,47,48,2,7), 2014)
nhomdieutri_sl_thuoc_nam_2015 <- nhomdieutri_sl_thuoc_nam(c(18,47,48,2,7), 2015)
nhomdieutri_sl_thuoc_nam_2016 <- nhomdieutri_sl_thuoc_nam(c(18,47,48,2,7), 2016)
nhomdieutri_sl_thuoc_nam_2017 <- nhomdieutri_sl_thuoc_nam(c(18,47,48,2,7), 2017)
nhomdieutri_sl_thuoc_nam_2018 <- nhomdieutri_sl_thuoc_nam(c(18,47,48,2,7), 2018)
